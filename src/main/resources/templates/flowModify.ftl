        ...
        <fieldset>
            ...
            <div class="form-group">
                ...
                <div class="col-md-4 inputGroupContainer">
                    <div class="input-group">
                        ...
                        <input id="bzjb" name="bzjb" value="${bzjb}" placeholder="步骤级别" class="form-control"  type="text">
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-4 inputGroupContainer">
                    <div class="input-group">
                        <span class="input-group-addon"><i class="glyphicon glyphicon-pencil"></i></span>
                        <input id="bzmc" name="bzmc" value="${bzmc}" placeholder="步骤名称" class="form-control"  type="text">
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-4 inputGroupContainer">
                    <div class="input-group">
                        <span class="input-group-addon"><i class="glyphicon glyphicon-pencil"></i></span>
                        <input id="bzts" name="bzts" value="${bzts}" placeholder="步骤提示" class="form-control"  type="text">
                    </div>
                </div>
            </div>
...
<script type="text/javascript" src="${contextPath}/js/flowModify.js"></script>
