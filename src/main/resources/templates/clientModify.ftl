        ...
        <fieldset>
            ...
            <div class="form-group">
                ...
                <div class="col-md-4 inputGroupContainer">
                    <div class="input-group">
                        ...
                        <input id="khmc" value="${khmc}" name="khmc" placeholder="客户名称" class="form-control"  type="text">
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-4 inputGroupContainer">
                    <div class="input-group">
                        <span class="input-group-addon"><i class="glyphicon glyphicon-pencil"></i></span>
                        <input id="khdz" value="${khdz}" name="khdz" placeholder="客户地址" class="form-control"  type="text">
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-4 inputGroupContainer">
                    <div class="input-group">
                        <span class="input-group-addon"><i class="glyphicon glyphicon-pencil"></i></span>
                        <input id="lxfs" value="${lxfs}" name="lxfs" placeholder="联系方式" class="form-control"  type="text">
                    </div>
                </div>
            </div>
...
<script type="text/javascript" src="${contextPath}/js/clientModify.js"></script>
<input type="hidden" id="ajax_url" value="${ajax_url}" />
<input type="hidden" id="hzsjTmp" value="${hzsj}" />
<input type="hidden" id="xhTmp" value="${xh}" />
</body>
