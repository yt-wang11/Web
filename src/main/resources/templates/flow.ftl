...
<div class="panel-body" style="padding-bottom:0px;">
    <div id="toolbar">
        <button id="btn_add" type="button" class="btn btn-default" onclick="flowAdd()">
            <span class="glyphicon glyphicon-plus" aria-hidden="true"></span>新增
        </button>
        <button id="btn_edit" type="button" class="btn btn-default" onclick="flowModify()">
...
<script type="text/javascript" src="${contextPath}/js/flow.js"></script>
</html>
