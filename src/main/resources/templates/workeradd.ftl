        ...
        <fieldset>
            ...
            <div class="form-group">
                ...
                <div class="col-md-4 inputGroupContainer">
                    <div class="input-group">
                        ...
                        <input id="grxm" name="grxm" placeholder="工人姓名" class="form-control"  type="text">
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-4 inputGroupContainer">
                    <div class="input-group">
                        <span class="input-group-addon"><i class="glyphicon glyphicon-pencil"></i></span>
                        <input id="yzje" value="0.0" readonly="readonly" name="yzje" placeholder="预支金额" class="form-control"  type="text">
                    </div>
                </div>
            </div>
...
<script type="text/javascript" src="${contextPath}/js/workeradd.js"></script>
